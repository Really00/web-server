...
export default {
  userLogin (data, headers) {
    return instance.post('/account/guest/login', qs.stringify(data), {
      headers: headers
    });
  },
  userLogout () {
    return instance.post('/account/guest/logout');
  },
  
  userEmail (data, headers) {
    return instance.post('/account/guest/', qs.stringify(data), {
      headers: headers
    });
  },
  userRegister (data, headers) {
    return instance.post('/account/guest/register', qs.stringify(data), {
      headers: headers
    });
  },
  ...
  getTask(params) {
    return instance.get('/object/task/one',params);
  },
  deleteIndividual(id) {
